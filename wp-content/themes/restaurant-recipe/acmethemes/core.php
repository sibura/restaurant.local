...
if ( ! function_exists( 'restaurant_recipe_setup' ) ) :
    ...
    function restaurant_recipe_setup() {
        ...
        add_theme_support( 'custom-background', apply_filters( 'restaurant_recipe_custom_background_args', array(
...
function restaurant_recipe_scripts() {
	...
	wp_localize_script( 'restaurant-recipe-custom', 'restaurant_recipe_ajax', array(
