    ...
    <article class="gutentor-get-started">
        ...
        <section>
            <div class="container">
                ...
                <div class="col">
                    <div class="gutentor-get-started-content">
                        <h3><?php esc_html_e('3. Start Desiging','gutentor'); ?></h3>
                        <p><?php esc_html_e('After Adding a Block in the editor, It is ready to Design','gutentor'); ?></p>
                        <p><?php echo sprintf( esc_html__( 'At right sidebar of Edit screen, there are Document and Block Tabs, under %s Block Tab %s, you will find setting to respective block.', 'gutentor' ), "<strong>","</strong>" ); ?></p>
                        <ul>
                            <li>
